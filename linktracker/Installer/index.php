...
<center>
  <div style="background:white;border:1px solid grey; width:450px;border-radius: 4px;" class="options">
  		...
  		<input type="text" class="form-control" style="width:90%;border-radius: 2px; border:1px solid #c1c1c1;" name="h" placeholder="Database Hostname"></input><br>
      <input type="text" class="form-control" style="width:90%;border-radius: 2px; border:1px solid #c1c1c1;" name="u" id="Username" placeholder="Database Username"></input><br>
      <input type="text" class="form-control" style="width:90%;border-radius: 2px; border:1px solid #c1c1c1;" name="n" id="Name" placeholder="Database Name"></input><br>
  		<input type="password" class="form-control" style="width:90%;border-radius: 2px; border:1px solid #c1c1c1;" name="p" id="pass" placeholder="Database Password"></input><br>
